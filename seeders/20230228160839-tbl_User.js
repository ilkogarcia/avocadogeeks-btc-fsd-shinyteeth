...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('tbl_Users', [
      ...
      {role_id:3, patient_id:null, professional_id:6, first_name:"María", middle_name:"Dolores", last_name:"Fuertes", mobile_phone:"618853843", email:"mariadolores@gmail.com", password_hash:"YWmALqTw", createdAt: new Date(), updatedAt: new Date()},
      {role_id:3, patient_id:null, professional_id:3, first_name:"Enrique", middle_name:"Almusafez", last_name:"Peperoni", mobile_phone:"654684925", email:"enrique4@yahoo.com", password_hash:"le02T5vI", createdAt: new Date(), updatedAt: new Date()},
      ...
      {role_id:3, patient_id:null, professional_id:8, first_name:"Leonor", middle_name:"Segovia", last_name:"", mobile_phone:"749267429", email:"leonor_segovia30@gmail.com", password_hash:"1I5ZVt8c", createdAt: new Date(), updatedAt: new Date()},
